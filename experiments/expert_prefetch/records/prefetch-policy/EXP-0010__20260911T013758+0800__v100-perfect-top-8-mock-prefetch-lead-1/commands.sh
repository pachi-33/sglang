...
EXP_DIR=/home/yaozhenyang/dev/sglang-v100/experiments/expert_prefetch/records/prefetch-policy/EXP-0010__20260911T013758+0800__v100-perfect-top-8-mock-prefetch-lead-1
...
PYTHONPATH=python:. "$PY" -m sglang.bench_serving \
  ...
  --mock-prefetch-lead-layers 1 --mock-prefetch-seed 0 \
