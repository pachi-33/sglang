...
EXP_DIR=/home/yaozhenyang/dev/sglang-v100/experiments/expert_prefetch/records/prefetch-policy/EXP-0008__20260910T195042+0800__v100-perfect-top-8-mock-prefetch-lead-8
...
PYTHONPATH=python:. "$PY" -m sglang.bench_serving \
  ...
  --mock-prefetch-lead-layers 8 --mock-prefetch-seed 0 \
...
PYTHONPATH=python:. "$PY" -m sglang.bench_serving \
  ...
  --random-output-len 16 --num-prompts 1 --random-range-ratio 1 \
  --random-input-token-ids --seed 0 --mock-expert-prefetch \
  --mock-prefetch-recall 1.0 --mock-prefetch-top-k 8 \
  --mock-prefetch-lead-layers 8 --mock-prefetch-seed 0 \
